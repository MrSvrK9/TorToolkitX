...
async def start_handler(event):
    msg = "Hello This is TorToolkitX running on heroku an instance of <a href='https://t.me/TEM_LEECH/TorToolkitX'>This Bot</a>. Join Our Channel And , To Get The Group Link."
...
async def booted(client):
    ...
    for i in chats:
        try:
            await client.send_message(i, "[𝚃𝙴𝙼] •𝚃𝚃𝙺• 𝙻𝙴𝙴𝙲𝙷 𝙱𝙾𝚃 3 is booted and is ready to use⚡.")
        except Exception:
